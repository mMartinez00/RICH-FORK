...
<div class="carousel slide" id="myCarousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="images/cropped-image7-11.jpg" style="width:100%" class="img-responsive img-center" alt="slider">
        </div>

        <!-- <div class="item">
            <img src="<?php echo e(asset('images/cropped-image7-11.jpg')); ?>" style="width:100%" class="img-responsive img-center" alt="slider">
        </div> -->
...
<div class="container spark-screen">
    <div class="row">
        ...
        <div class="col-md-6 mission">
            <img src="images/kids3.png"  alt="kids at computer" style="width:100%" class="img-responsive img-center">
        </div>
    </div>
</div>
